 ...
 *
 * Source file: assets/civitai-icon.png (28x28, transparent).
 */
...
/** Small <img> of the logo, for use inside the panel. */
export function makeLogo(size, alt) {
  var img = document.createElement("img");
  img.src = CIVITAI_LOGO_PNG;
  img.alt = alt || "Civitai";
